...
Nonprofit leaders, program staff, IT-adjacent generalists, board members, and funders. Specifically designed for organizations under ~$10M budget that can't afford bespoke consulting. The voice is plain, skeptical, and practical. No vendor-speak, no hype.
...
Pure HTML, CSS, and vanilla JavaScript. No build step, no framework, no tracking. Hosted on GitHub Pages with a Porkbun domain. Forms wired to Formspree. Open Graph image and structured metadata for link previews.

## License

Content licensed Creative Commons Attribution-NonCommercial 4.0 (CC BY-NC 4.0). You're welcome to share, adapt, and use these materials for nonprofit and educational work with attribution. Commercial reuse requires permission.

## Contributing

Spotted an error, a broken link, or a gap in coverage? Open an issue, or use the suggestion form on the [Get Help](https://aimissionready.org/#about) page.
